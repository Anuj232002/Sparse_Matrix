...
{
printf("Row\t"); for(int  i=0;i<=n;i++)
{
printf("%d\t",a[i][0]);
}
printf("\n"); printf("Column\t"); for(int  i=0;i<=n;i++)
{
printf("%d\t",a[i][1]);
}
printf("\n"); printf("Value\t"); for(int  i=0;i<=n;i++)
{
printf("%d\t",a[i][2]);
}
printf("\n");
...
int  ans[n+1][3],location; ans[0][0]=a[0][1];
ans[0][1]=a[0][0];
ans[0][2]=a[0][2];
for(int  i=1;i<=n;i++)
{
location  =  index[a[i][1]]; ans[location][0]  =  a[i][1];
...
{
int  c[10][3]; c[0][0]=a[0][0];
c[0][1]=a[0][1];
int  i=1,j=1,k=1; while(i<=n  &&  j<=m)
{
if(a[i][0]  <  b[j][0])
{
c[k][0]  =  a[i][0];
...
{
c[k][0]  =  a[i][0];
c[k][1]  =  a[i][1];  c[k][2]  =  a[i][2]+b[j][2]; i++;
j++; k++;
}
}
while(i<=n)
...
scanf("%d%d%d",&r1,&c1,&n); ans[0][0]=r1;
ans[0][1]=c1;
ans[0][2]=n;
